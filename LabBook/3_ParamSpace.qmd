...
The ISCO is proportional to both $\alpha_{13}$ and $\epsilon_3$, and inversely proportional to the spin.
...
To maximise readablity of the redshift images, a custom colormap is made through `RedshiftColormap` which gives red for any values $<1$, blue for those $>1$, and white for those $=1$. This gave the images seen in [@fig-alpha13Render; -@fig-epsilon3Render; -@fig-inclRender; -@fig-spinRender].