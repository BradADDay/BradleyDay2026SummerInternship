...
Alongside the line profiles, images of the accretion disk were rendered with a colourmap denoting the redshift of light from a given part of the disk.

![The effect of $\alpha_{13}$ on the accretion disk render. The event horizon seems to grow with $\alpha_{13}$](images/alpha13Render.png){fig-align="center" #fig-alpha13 width=80%}

![](images/epsilon3Render.png){fig-align="center" #fig-epsilon3Render width=80%}

![](images/inclRender.png){fig-align="center" #fig-inclRender width=80%}

![](images/coronaHeightRender.png){fig-align="center" #fig-coronaHeightRender width=80%}

![](images/spinRender.png){fig-align="center" #fig-spinRender width=80%}