...
a = range(-0.998, 0.998, 100)

plot(a, Constraints.(a); xlabel="Black hole spin", ylabel=L"\alpha_{13}\;/\;\epsilon_{3}", gridalpha=0.5, minorgrid=true, minorgridalpha=0.3, label=nothing, ylims=(-8,0), c=:black)
hline!([-1], linestyle=:dash, c=:red, label=nothing)
```

<!-- 
To Do:
- Get working on PC/GPU
- Figure out if dynamically setting lower bound is possible
