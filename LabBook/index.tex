...
~{[}1{]}}\label{summary-of-broad-iron-lines-in-active-galactic-nuclei-fabian_broad_2000}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/ShapeOfIronLine.jpg}}
...
{\centering \includegraphics[width=10cm,height=\textheight,keepaspectratio]{images/ReflectionSpectrum.jpg}
...
{\centering \includegraphics[width=10cm,height=\textheight,keepaspectratio]{images/EquivalentWidth.png}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/render.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/InitialHVariation.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/epsilon3vars.png}}

\begin{figure}[H]

{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/alpha13vars.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/alpha13.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/epsilon3.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/inclination.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/coronaHeight.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/spin.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/FirstFit.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/FirstDataFit.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/DualFit.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/Johannsennu80402315002.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/Kerrnu80402315002.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/alpha13spin.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/TableKerrnu80402315002.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/TableJohannsennu80402315002.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/GradusTableCompare.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/Regions.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/BottomRegion.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/SourceRegion.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/TopRegion.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/Raw.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/Clean.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/BadPX.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/RiseTime.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/Proximity.png}}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{images/SourceBgdRegions.png}}
\end{center}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/DeformParameterSpace_a=0.0.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/DeformParameterSpace_a=0.0.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/DeformParameterSpace_a=0.2495.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/DeformParameterSpace_a=0.499.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/DeformParameterSpace_a=0.7485.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/DeformParameterSpace_a=0.998.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/ParamBounds.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/alpha13Allowed.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/epsilon3Allowed.png}}
...
\begin{minipage}[t]{0.50\linewidth}
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{images/Fail1.png}}
\end{center}
\end{minipage}%
%
\begin{minipage}[t]{0.50\linewidth}
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{images/Fail2.png}}
\end{center}
\end{minipage}%
\newline
\begin{minipage}[t]{0.50\linewidth}
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{images/Fail3.png}}
\end{center}
\end{minipage}%
%
\begin{minipage}[t]{0.50\linewidth}
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{images/Fail4.png}}
\end{center}
\end{minipage}%
\newline
\begin{minipage}[t]{0.50\linewidth}
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{images/Fail5.png}}
\end{center}
\end{minipage}%
%
\begin{minipage}[t]{0.50\linewidth}
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{images/Fail6.png}}
\end{center}
\end{minipage}%
\newline
\begin{minipage}[t]{0.50\linewidth}
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{images/Fail7.png}}
\end{center}
\end{minipage}%
%
\begin{minipage}[t]{0.50\linewidth}
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{images/Fail8.png}}
\end{center}
\end{minipage}%
\newline
\begin{minipage}[t]{0.50\linewidth}
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{images/Fail9.png}}
\end{center}
\end{minipage}%
%
\begin{minipage}[t]{0.50\linewidth}
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{images/Fail10.png}}
\end{center}
\end{minipage}%
\newline
\begin{minipage}[t]{0.50\linewidth}
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{images/Fail11.png}}
\end{center}
\end{minipage}%
%
\begin{minipage}[t]{0.50\linewidth}
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{images/Fail12.png}}
\end{center}
\end{minipage}%
\newline
\begin{minipage}[t]{0.50\linewidth}
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{images/Fail13.png}}
\end{center}
\end{minipage}%
%
\begin{minipage}[t]{0.50\linewidth}
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{images/Fail14.png}}
\end{center}
\end{minipage}%
\newline
\begin{minipage}[t]{0.50\linewidth}
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{images/Fail15.png}}
\end{center}
\end{minipage}%
...
\chapter{Properties of the Deformation
Parameters}\label{properties-of-the-deformation-parameters}

\section{\texorpdfstring{\(\alpha_{13}\)}{\textbackslash alpha\_\{13\}}}\label{alpha_13}

\(\alpha_{13}\) is the highest order deformation parameter in the
Johannsen metric and thus has the largest effect on the line profile.
The animation below shows the effect of \(\alpha_{13}\) on the observed
image of the disc. The radius of the ISCO and degree of doppler shifting
observed both increase with \(\alpha_{13}\). The doppler shifting trend
is due to an increase in the Keplerian (orbital) frequency of
surrounding particles ~{[}3{]}: ``Keplerian frequency increases for
increasing values of the parameter \(\alpha_{13}\)''. An increase in
orbital frequency leads to an increase in relative speed to an observer,
and thus increased redshifting is observed.

\begin{figure}[H]

{\centering \includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{images/alpha.gif}

}

\caption{A rendered image of a thin accretion disk around a Johannsen
black hole with varying \(\alpha_{13}\). The colour scale denotes the
doppler shift of the light emitted from each region of the disk.}

\end{figure}%

The plot below shows \(R_\text{ISCO}\) as a function of \(\alpha_{13}\)
for varying \(a\).
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{images/ISCOPlotCombined.png}

}

\caption{\label{fig-alphaISCO}The radius of the ISCO as a function of
the deformation parameter \(\alpha_{13}\) for various values of the
black hole spin, \(a\).}

\end{figure}%

For \(\alpha_{13} \lesssim -5.7\) the energy can have two local minima
and stable circular orbits can only exist at and outside of the radius
of the local maximum between them ~{[}3{]}. The effect of this on the
ISCO can be seen in Figure~\ref{fig-alphaISCO} where the behaviour of
the ISCO becomes chaotic below \(\alpha_{13} \approx -5.7\). For
\(\alpha_{13} \lesssim -6.2\), the energy and Keplerian frequency of an
orbiting particle become imaginary in a small range of radii.

\begin{figure}[H]

{\centering \includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{images/Johannsen_Alpha13Spin.png}

}

\caption{The dependence on the ISCO radius on \(\alpha_{13}\). In the
green shaded region the energy has two local minima and the ISCO is
located at the outer radius where these minima occur. In the red shaded
region, circular equatorial orbits do not exist at radii \(r\sim 2.5M\)
and the ISCO is located at the outer boundary of this radial interval.
Image credit Johannsen (2013) ~{[}3{]}.}

\end{figure}%

\section{\texorpdfstring{\(\epsilon_{3}\)}{\textbackslash epsilon\_\{3\}}}\label{epsilon_3}

The animation below shows the effect of \(\epsilon_{3}\) on the observed
image of the disc. The radius of the ISCO changes only slightly and
degree of doppler shifting observed decreases with increasing
\(\epsilon_{3}\). The doppler shifting trend is due to a decrease in the
Keplerian frequency of surrounding particles ~{[}3{]}.

\begin{figure}[H]

{\centering \includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{images/epsilon.gif}

}

\caption{A rendered image of a thin accretion disk around a Johannsen
black hole with varying \(\epsilon_{3}\). The colour scale denotes the
doppler shift of the light emitted from each region of the disk.}

\end{figure}%

The plot below shows \(R_\text{ISCO}\) as a function of \(\epsilon_{3}\)
for varying \(a\).

\begin{figure}[H]

{\centering \includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{images/EpsilonISCOPlot.png}

}

\caption{The radius of the ISCO as a function of the deformation
parameter \(\epsilon_{3}\) for various values of the black hole spin,
\(a\).}

\end{figure}%

The radius of the ISCO decreases for \(a \lesssim 0.7\). For
\(a \gtrsim 0.7\) the radius decreases before increasing, and for very
large \(a\) the radius only increases. The discontinuous regions seen
for \(a=0.887,\; 0.998\) are due to the boundaries set by
Equation~\ref{eq-Epsilon3Constraint}.
...
\tightlist
\item
  The main takeaway from this section of research is that
  \(\alpha_{13}\) should not only be disallowed from being in the
  bounded regions of parameter space, but should also not be allowed to
  go below -5.7. This was implemented in the assembly of the final table
  model.
\item
  The observed change in redshift is due to test particles physically
  changing speed.
\end{itemize}

\bookmarksetup{startatroot}

\chapter{Fitting the Refined Model to the
Data}\label{fitting-the-refined-model-to-the-data}

With the table model constructed and the parameter space now understood,
it was possible to start fitting to data. To refine the fitting process
the processed XRISM dataset of NGC4151 was used. Modifications had to be
made to the previous fitting code to include a rest frame spectrum, and
photoelectric absorption. The rest frame model \texttt{XILLVER} was
selected as implemented through \texttt{SpectralFitting.jl}.
...
where \texttt{PhotoelectricAbsorption}, \texttt{PowerLaw}, and
\texttt{XillverD5} were implemented through \texttt{SpectralFitting.jl}.
\texttt{ConvolutionLineProfile} is the table model defined here using
the Johannsen metric, and convolving over the reflection spectrum to
apply the relativistic properties to the emission lines. The parameters
of the model are shown below. Note that the photon index appears in both
the spectrum and the power law, and the inclination appears in both the
spectrum and the line profile. These two pairs of parameters were bound
...
& \(\alpha_{13}\) & 0 & (-6, 10) \\
& \(\epsilon_{3}\) & 0 & (-8, 10) \\
\texttt{XILLVER} & Normalisation (\(K\)) & 0.01 & (0, \(\infty\)) \\
...
\bibitem[\citeproctext]{ref-fabian_broad_2000}
\CSLLeftMargin{{[}1{]} }%
\CSLRightInline{A. C. Fabian \emph{et al.}, (2000).}

\bibitem[\citeproctext]{ref-harrison_nuclear_2013}
\CSLLeftMargin{{[}2{]} }%
\CSLRightInline{\href{https://doi.org/10.1088/0004-637X/770/2/103}{F. A.
Harrison \emph{et al.}, The Astrophysical Journal \textbf{770}, 103
(2013)}.}

\bibitem[\citeproctext]{ref-johannsen_regular_2013}
\CSLLeftMargin{{[}3{]} }%
\CSLRightInline{\href{https://doi.org/10.1103/PhysRevD.88.044002}{T.
Johannsen, Physical Review D \textbf{88}, 044002 (2013)}.}
